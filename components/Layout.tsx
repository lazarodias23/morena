          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
            <div>
              ...
              <p className="text-zinc-400 text-sm leading-relaxed mb-6">
                A elite do acompanhamento de luxo em São Paulo. Conectamos cavalheiros de bom gosto a mulheres extraordinárias para momentos inesquecíveis.
              </p>
              <div className="flex gap-4">
                <a href="#" className="p-2 bg-zinc-800 rounded-full hover:bg-brand-red transition-colors text-white"><Instagram size={18} /></a>
                <a href="#" className="p-2 bg-zinc-800 rounded-full hover:bg-brand-red transition-colors text-white"><Twitter size={18} /></a>
                <a href="#" className="p-2 bg-zinc-800 rounded-full hover:bg-brand-red transition-colors text-white"><Lock size={18} /></a>
              </div>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-4 text-sm text-zinc-400">
                <li className="flex items-start gap-3">
                  ...
                  <span>Jardins & Itaim Bibi<br/>São Paulo - SP</span>
                </li>
                ...
                <li className="flex items-center gap-3">
                  ...
                  <span>booking@morenabruta.com</span>
                </li>
              </ul>
            </div>
